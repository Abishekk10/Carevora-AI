    ...
    <article className="surface group p-5 transition duration-200 hover:-translate-y-0.5 hover:shadow-lg">
      <div className="flex gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <a href={job.apply_url} target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-indigo-600 hover:text-indigo-700">View role <ExternalLink className="h-4 w-4" /></a>
        </div>
      </div>
    </article>
  );
